                ...
                <div class="imagecart">
                    ...
                    <div class="showcart">
                        ...
                        <div class="bottomcart">
                            <form id="formbuy" action="<?= BASEURL . '/customer/buybookproccess' ?>" method="post">
                                ...
                                <input type="hidden" name="payment" id="mode" value="online">
                                ...
                                <div class="buttonbotcart">
                                    ...
                                    <button class="tbuy checkout" name="cart" type="submit">Buy</button>
                                </div>
                            </form>
                        </div>
                    </div>
